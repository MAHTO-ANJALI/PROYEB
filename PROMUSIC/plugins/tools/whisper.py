        ...
        try:
            ...
            mm = [
                InlineQueryResultArticle(
                    ...
                    input_message_content=InputTextMessageContent(f"🔒 A whisper message to @{user.username}.\n\nOnly he/she can open it."),
                    thumb_url="https://i.ibb.co/0CZmTg8/istockphoto-1254403222-612x612.jpg",
                ...
                InlineQueryResultArticle(
                    ...
                    input_message_content=InputTextMessageContent(f"📩 A one-time whisper message to @{user.username}.\n\nOnly he/she can open it."),
                    thumb_url="https://i.ibb.co/0CZmTg8/istockphoto-1254403222-612x612.jpg",
